...
const RECIPES: WorkflowRecipe[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'docs-v2-overwrite', purpose: 'Use Feishu docs v2 Markdown overwrite for whole documents whose tables or local images/SVGs need native Feishu rendering.', command: 'md2feishu push <doc.md> <feishu-doc> --write-backend docx-v2-overwrite --image-root-dir <static-dir> --image-size /img/diagram.svg=900x393 --replace-all --write -y', writes: 'feishu', verifies: 'Dry-run showed document-replace, full replacement was approved, and table and media readback counts pass.' },
